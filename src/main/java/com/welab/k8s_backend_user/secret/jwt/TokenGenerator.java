...
public class TokenGenerator {
    ...
    public TokenDto.AcessRefreshToken generateAccessRefreshToken(String userId, String deviceType) {
        ...
        return new TokenDto.AcessRefreshToken(accessJwtToken, refreshJwtToken);
    }
